...
A consequence of the \emph{Theorema Egregium} is that it is impossible to isometrically embed the hyperbolic plane as a complete subset of \esp
...
Here we shall define a construction as an approximation of an isometric embedding of the hyperbolic plane as a surface in \esp \cite{crochetplane}, as opposed to compass-and-straightedge constructions.\footnote{These could also be described as yarn-and-crochet-hook constructions.}
