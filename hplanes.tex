...
While \eqref{circle} is equivalent to \eqref{gauss}, the Gaussian curvature (defined in \eqref{gauss}) is rather more useful.
...
Why construct hyperbolic planes in $\mathbb{R}^3$?
